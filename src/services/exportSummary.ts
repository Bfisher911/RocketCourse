...
export const buildImportChecklistText = (course: CourseProject, report: ExportValidationReport | null): string => {
  ...
  const lines: string[] = [
    ...
    "",
    "Verify after import:",
    "[ ] Rename the Canvas course and course code if the destination shell still has a blank or template name.",
    ...
    "[ ] Quizzes use the intended response control and correct-answer logic.",
    "[ ] Every rubric includes a 0-point Not yet demonstrated level.",
    "[ ] Due and availability dates match the official term calendar.",
    "[ ] Instructor contact details, materials, policies, and campus support links are confirmed.",
    "[ ] Pages render with no missing content or broken links.",
    "[ ] Settings → Navigation hides unused institution tools and external apps.",
    "[ ] Home-page announcement display matches the instructor's preference.",
    "[ ] Student View confirms the start path and module navigation.",
