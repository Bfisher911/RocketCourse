  ...
  return (
    <div className="app">
      <TopBar
        ...
        supabaseConnected={supabaseConfig.isConfigured}
...
function TopBar({
  ...
  return (
    <header className="topbar">
      ...
      <span className={`supabase-status ${supabaseConnected ? "connected" : "missing"}`}>
        {supabaseConnected ? "Supabase connected" : "Supabase env needed"}
      </span>
    </header>
  );
}
