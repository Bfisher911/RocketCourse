...
export const INTERACTION_PATTERNS: InteractionPatternDef[] = [
  ...
  def({ n: 3, id: "faq-accordion", name: "FAQ Accordion", cat: "structure", tpl: "reveal-panels", best: "Answer common student questions in a compact format.", guide: "Replace the sample questions with course-specific questions.", purposes: ["support", "clarity"], pages: ["orientation", "assignment"], freq: "frequent", cx: 1 }),
  ...
  def({ n: 43, id: "interactive-troubleshooting-guide", name: "Interactive Troubleshooting Guide", cat: "planning", tpl: "reveal-panels", best: "Route students from a problem to a likely solution.", guide: "Create one expandable issue per common problem.", purposes: ["support", "procedure"], pages: ["assignment", "orientation"], cx: 1 }),
  ...
  def({ n: 59, id: "course-navigation-map", name: "Course Navigation Map", cat: "planning", tpl: "card-link-grid", best: "Provide a visual map to Start Here, modules, assignments, support, and grades.", guide: "Use Canvas page, module, and assignment links.", purposes: ["navigation"], pages: ["homepage", "orientation"], cx: 1 }),
  def({ n: 60, id: "resource-recommendation-menu", name: "Resource Recommendation Menu", cat: "planning", tpl: "card-link-grid", best: "Route students to the right support based on what they need.", guide: "Offer focused links for concepts, research, writing, technology, and personal support.", purposes: ["support", "navigation"], pages: ["orientation", "recap"], cx: 1 }),
