# RocketCourse Canvas Builder MVP Plan

> RocketCourse was formerly named CourseForge. This is the original MVP plan, rebranded; it captures
> the product requirements, architecture, data model, AI pipeline, and export strategy.

## 1. Product Requirements Document

### Product Summary
RocketCourse Canvas Builder is a SaaS app for instructors and instructional designers who need to turn a course idea, syllabus, notes, or reading list into a polished Canvas LMS course shell. The MVP focuses on one promise: generate a structured, editable course and export a Canvas-oriented `.imscc` package that can be imported into a blank Canvas course.
